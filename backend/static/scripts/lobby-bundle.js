(() => {
  ...
  (s.n = (t) => {
    ...
    (() => {
      ...
      var _t = s(606),
        kt = s.n(_t);
      const wt = mt()(document.location.pathname),
      ...
      var At = s(906);
      const Ct = document.querySelector("#games-list"),
        Tt = document.querySelector("#available-game-item");
      !(function (t) {
        t.on(At.GAME_CREATED, ({ game_id: t, game_title: e }) => {
          Ct.appendChild(
            (function (t, e) {
              const s = Tt.content.cloneNode(!0);
              return (
                s
