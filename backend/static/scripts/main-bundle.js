(() => {
  var t = {
      ...
      147: (t, e, s) => {
        ...
        function k(t, e) {
          e.useNativeTimers
            ? ((t.setTimeoutFn = w.bind(b)), (t.clearTimeoutFn = _.bind(b)))
        ...
        function tt(t) {
          return (
            (J && (t instanceof ArrayBuffer || Q(t))) ||
            (G && t instanceof Blob) ||
            (Z && t instanceof File)
          );
        }
  ...
  (s.n = (t) => {
    ...
    (() => {
      ...
      var t = s(147),
        ...
        n = s.n(e),
        i = s(123);
      const r = s.n(i)()(document.location.pathname),
      ...
      var a = s(906);
      const h = document.querySelector("#games-list"),
        c = document.querySelector("#available-game-item");
      !(function (t) {
        t.on(a.GAME_CREATED, ({ game_id: t, game_title: e }) => {
          h.appendChild(
            (function (t, e) {
              const s = c.content.cloneNode(!0);
              return (
                s
    ...
    (() => {
      ...
      var t = s(147),
        e = s(123);
      const n = s.n(e)()(document.location.pathname);
      t.Z.on("joined-waiting-list", (t) => {
        ...
        t.Z.on("game-started", () => {
          window.location.pathname = "/games/" + n;
        });
    })();
})();
